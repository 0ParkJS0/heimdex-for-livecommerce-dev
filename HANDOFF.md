...
- **Phase 1**: 일부 완료 + 커밋됨 (커밋 d2658a1 + 2c109d4)
  - ✅ 화자 색상 매핑 (red-h/green-h)
  - ✅ 탭 nav navy 적용
  - ⏳ 미완: AI badge 색상 (line 408), AutoShortsCTA 색상, ScenesPanel "쇼츠 제작" 버튼 navy, OverviewPanel 복사 버튼 등 indigo 잔존 정리, type-check
