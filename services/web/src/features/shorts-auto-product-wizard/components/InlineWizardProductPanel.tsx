...
export function InlineWizardProductPanel({
  ...
  return (
    <div className="space-y-[20px] font-pretendard">
      ...
      <div className="space-y-[20px] rounded-card bg-white p-[20px] shadow-card">
        ...
        {pollState === "ready" && entries.length > 0 ? (
          <div
            className="grid grid-cols-2 gap-[20px] sm:grid-cols-3 md:grid-cols-4"
              ...
              return (
                ...
                >
                  <div className="aspect-square overflow-hidden bg-neutral-h-50">
                    ...
                    <span
                      className={cn(
                        "absolute right-[8px] top-[8px] flex h-[24px] w-[24px] items-center justify-center rounded-[6px] transition",
                        isSelected
